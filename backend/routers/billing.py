...
async def create_checkout(
    ...
    try:
        ...
        checkout_request = CheckoutSessionRequest(
            success_url=f"https://propops-preview.preview.emergentagent.com/billing?success=true&session_id={{CHECKOUT_SESSION_ID}}",
            cancel_url="https://propops-preview.preview.emergentagent.com/billing?canceled=true",
            line_items=[{
                "price_data": {
                    "currency": "usd",
                    "product_data": {
...
async def create_embedded_checkout(
    ...
    try:
        checkout_session = stripe.checkout.Session.create(
            ...
            mode="payment",
            return_url=f"https://propops-preview.preview.emergentagent.com/billing?session_id={{CHECKOUT_SESSION_ID}}",
            metadata={
                "org_id": org_id,
                "user_id": current_user["id"],
                "plan_id": plan_id,
